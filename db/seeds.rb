...
races = [[1, 'Maiden Claiming Purse $9,975', '(Maiden, 3YO)','2014-08-01 12:00:00', 'Published', "Alternate",'Furlongs', 4.5, 5000, 150000,'2014-07-27 12:00:00'], 
...
new_tel = Tel.find_or_create_by!(weekend_start: '2014-08-01 00:00:00', meet_id: meet.id)
new_tel.save
