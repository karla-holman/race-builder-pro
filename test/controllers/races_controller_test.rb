...
class RacesControllerTest < ActionController::TestCase
  ...
  test "should create race" do
    assert_difference('Race.count') do
      post :create, race: { created_at: @race.created_at, name: @race.name, race_number: @race.race_number, updated_at: @race.updated_at }
    end
  ...
  test "should update race" do
    patch :update, id: @race, race: { created_at: @race.created_at, name: @race.name, race_number: @race.race_number, updated_at: @race.updated_at }
    assert_redirected_to race_path(assigns(:race))
  end
