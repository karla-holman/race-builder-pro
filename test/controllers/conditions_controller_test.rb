...
class ConditionsControllerTest < ActionController::TestCase
  ...
  test "should create condition" do
    assert_difference('Condition.count') do
      post :create, condition: { condition_category_id: @condition.condition_category_id, name: @condition.name }
    end
  ...
  test "should update condition" do
    patch :update, id: @condition, condition: { condition_category_id: @condition.condition_category_id, name: @condition.name }
    assert_redirected_to condition_path(assigns(:condition))
  end
